...
public class ClientController implements Serializable {
    ...
    @EJB
    private ejb.ClientFacade ejbFacade;
    ...
    protected void initializeEmbeddableKey() {
        selected.setClientPK(new entity.ClientPK());
    }
    ...
    public Client getClient(entity.ClientPK id) {
    ...
    public static class ClientControllerConverter implements Converter {
        ...
        entity.ClientPK getKey(String value) {
            entity.ClientPK key;
            String values[] = value.split(SEPARATOR_ESCAPED);
            key = new entity.ClientPK();
            key.setClientName(values[0]);
            key.setClientDepartmentNumber(Short.parseShort(values[1]));
            return key;
        }

        String getStringKey(entity.ClientPK value) {
