...
import ejb.ConsultantStatusFacade;
...
public class ConsultantStatusController implements Serializable {
    ...
    @EJB
    private ejb.ConsultantStatusFacade ejbFacade;
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/Bundle").getString("ConsultantStatusCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/Bundle").getString("ConsultantStatusUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/Bundle").getString("ConsultantStatusDeleted"));
        if (!JsfUtil.isValidationFailed()) {
