...
public class ProjectController implements Serializable {
    ...
    @EJB
    private ejb.ProjectFacade ejbFacade;
    ...
    protected void initializeEmbeddableKey() {
        selected.setProjectPK(new entity.ProjectPK());
    }
    ...
    public Project getProject(entity.ProjectPK id) {
    ...
    public static class ProjectControllerConverter implements Converter {
        ...
        entity.ProjectPK getKey(String value) {
            entity.ProjectPK key;
            String values[] = value.split(SEPARATOR_ESCAPED);
            key = new entity.ProjectPK();
        ...
        String getStringKey(entity.ProjectPK value) {
